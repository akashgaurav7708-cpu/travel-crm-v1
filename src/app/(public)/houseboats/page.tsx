...
import { Anchor, Star, Sparkles, MapPin, Coffee, ShieldCheck, Waves } from 'lucide-react';
    ...
    <div className="pt-32 pb-24 bg-white dark:bg-zinc-950 text-zinc-900 dark:text-slate-100 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-16">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-lg max-w-2xl leading-relaxed">Experience a royal floating stay carved with centuries-old cedar woodcraft. Direct heritage properties owned and operated by Javid Farooq's local family.</p>
          ...
          {houseboats.map((hb, index) => (
            ...
            >
              ...
              <div className="lg:w-1/2 w-full space-y-6">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">{hb.desc}</p>
                <div className="flex gap-4 items-center pt-2">
                  <span className="text-xs bg-slate-100 dark:bg-zinc-800 border dark:border-zinc-700 px-3.5 py-1.5 text-slate-500 dark:text-slate-300 font-bold uppercase rounded-lg">
                    {hb.rooms}
                  </span>
                </div>
